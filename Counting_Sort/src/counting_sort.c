...
//Author		:Vivek Malik
//Description	:Sorting an Array using Counting sort Algorithm
//////////////////////////////////////////////////////////////////////////////////////
#include<stdio.h>
#include<stdlib.h>

void counting_sort(int arr[],int *, int *);

int main(){
	setvbuf(stdout, NULL, _IONBF, 0);
	setvbuf(stderr, NULL, _IONBF, 0);
	int arr[50],i,n, max_ele;
...
//	printf("%d",max_ele);
	counting_sort(arr,&n,&max_ele);
	return(0);
}

void counting_sort(int arr[],int *high, int *k){
